...
alert_types=  [
    ...
    AlertType.SUPPORT_RESISTANCE_BREAKOUT_DOWN, AlertType.SUPPORT_RESISTANCE_BREAKOUT_UP, AlertType.SR_CONSOLIDATING, AlertType.BELOW_LOWEST_SR_BAND, AlertType.ABOVE_HIGHEST_SR_BAND, #sr bands
